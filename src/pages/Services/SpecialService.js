      ...
      <div className="">
        <div className="">
          <div className="mx-auto  my-5 lg:max-w-xl sm:text-center">
            <p className="inline-block px-3  mb-4  font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-accent-400 text-center text-2xl">
              Delicious foods are here
            </p>
            <p className="text-base text-gray-700 md:text-lg">
              When the time is cooking, the smell is incredible. In fact, it’s
              how I met most of my neighbours when I lived in a townhouse
              complex.
            </p>
          </div>
