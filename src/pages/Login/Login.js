      ...
      <div className="flex flex-col items-center justify-between lg:flex-row">
        <div className="mb-10 lg:max-w-lg lg:pr-5 lg:mb-0">
          <div className="flex justify-center items-center pt-8 mb-10 ">
            <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-orange-500">
              ...
              >
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full px-8 py-3 font-semibold rounded-md bg-orange-500 hover:bg-orange-600 hover:text-white text-gray-100"
                  >
                    Sign in
                  </button>
                </div>
